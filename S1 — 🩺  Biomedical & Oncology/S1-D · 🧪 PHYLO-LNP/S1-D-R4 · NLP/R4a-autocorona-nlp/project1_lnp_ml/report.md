...
A second open question concerns the role of the **protein corona** вЂ” the layer of serum proteins adsorbed onto LNPs in biological fluids. The corona is known to modulate cellular uptake and organ tropism, but its relationship to transfection efficacy is poorly characterized due to sparse data.
...
- **15 source publications** (2008вЂ“2020)
...
**Ionizable lipid molecular descriptors (10):** Molecular weight (MW), LogP, hydrogen bond donors (HBD), hydrogen bond acceptors (HBA), rotatable bonds, topological polar surface area (TPSA), fraction spВі carbon (Frac.sp3C), number of rings, number of aromatic rings, ionizable head group pKa
...
4. **Temporal generalization:** The model is trained on publications from 2008вЂ“2020. Novel lipid scaffolds (e.g., ionizable lipidoids, branched-tail lipids) may fall outside the training distribution.
...
2. Billingsley MM, et al. (2020). Ionizable lipid nanoparticle-mediated mRNA delivery for human CAR T cell engineering. *Nano Letters*, 20(3), 1578вЂ“1589.
...
4. Sabnis S, et al. (2018). A novel amino lipid series for mRNA delivery. *Molecular Therapy*, 26(6), 1509вЂ“1519.
5. Kulkarni JA, et al. (2019). The current landscape of nucleic acid therapeutics. *Nature Nanotechnology*, 14, 1084вЂ“1087.
6. Lundberg SM, Lee SI. (2017). A unified approach to interpreting model predictions. *NeurIPS*, 30.
7. Chen T, Guestrin C. (2016). XGBoost: A scalable tree boosting system. *KDD*, 785вЂ“794.
8. Semple SC, et al. (2010). Rational design of cationic lipids for siRNA delivery. *Nature Biotechnology*, 28, 172вЂ“176.
9. Jayaraman M, et al. (2012). Maximizing the potency of siRNA lipid nanoparticles for hepatic gene silencing in vivo. *Angewandte Chemie*, 51(34), 8529вЂ“8533.
10. Akinc A, et al. (2008). A combinatorial library of lipid-like materials for delivery of RNAi therapeutics. *Nature Biotechnology*, 26, 561вЂ“569.
