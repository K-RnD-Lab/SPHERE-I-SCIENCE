...
const dir = __dirname;
const basePath = path.join(dir, "master_prep_exam_guide_v15_teaching_deep.html");
const outPath = path.join(dir, "master_prep_exam_guide_v16_teaching_deep.html");
...
const deepAppendix = `
  <section class="section page-break">
    <div class="module">
      <div class="kicker">Оновлення v16</div>
...
html = html.replace("\n</div>\n</body>", `${deepAppendix}\n</div>\n</body>`);
html = html.replace(/v15/g, "v16");
html = html.replace("Master Prep Exam Teaching Guide v16", "Master Prep Exam Teaching Guide v16");
